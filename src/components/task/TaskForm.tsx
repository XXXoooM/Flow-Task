        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2 rounded-lg border border-border p-3">
            ...
            {form.scheduleOn && (
              <div className="space-y-3 border-t border-border pt-3">
                <div className="space-y-1.5">
                  <Label htmlFor="tf-when">时间</Label>
                  <input
                    id="tf-when"
                    type="datetime-local"
                    value={form.scheduledAt}
                    onChange={(e) => patch({ scheduledAt: e.target.value })}
                    className="h-9 w-full rounded-md border border-input bg-transparent px-3 text-sm text-text-primary outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-sm text-text-primary">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder="支持 Markdown（渲染在 P4 完善）"
              rows={4}
            />
          </div>
